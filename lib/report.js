...
module.exports.run = (buildId) => {
  return promiseRetry(function (retry, number) {
    ...
    return greenStatus(buildId)
      ...
      if(build.buildStatus === 'FAILED' && failureSnsTopic) reportFailureToSns(buildId, failureSnsTopic, getCommitter(build))
